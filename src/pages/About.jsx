...
const About = () => {
  return (
    <div className="bg-[#EFEDE6]">
      <div className="flex flex-col justify-center items-center max-w-screen-2xl mx-auto px-4 md:px-12 xl:px-16 2xl:px-20 py-10 gap-y-5">
        <h1>Executive Coach, Tested Executive, Corporate Board Member</h1>
        <p>
          ...
          codifying a unified vision that aligns corporate values and individual
          aspirations. Darrell accelerates revenue diversification efforts that
          embrace core competencies and are rooted in sound financial and data
          driven strategies. He believes people are a company’s greatest
          treasure and operates from the Simon Sinek quote, “Leadership is not
          about being in charge, it is about taking care of those in your
          charge”.
        </p>
        <p>
          Darrell currently serves as President &amp; Chief Executive Officer of
          Safety Center Incorporated, a California-based, social enterprise
          excelling in safety training and education. At Safety Center, Darrell
          leads one of the California’s largest and most effective safety
          training organization’s which specializes in workplace safety training
          and DUI education, and serves customers in California, Arizona, and
          Washington.
        </p>
        <p>
          ...
          Personnel. At Nehemiah, he also led the development of Township 9, an
          award winning, 65-acre urban infill project.
        </p>
        <p>
          Darrell is a recipient of the National Basketball Association (NBA) –
          Dream Big All-Star Award, American Diabetes Association – Father of
          the Year Award, Sacramento Metropolitan Chamber of Commerce – Al
        ...
        <p>
          Sacramento Metropolitan Chamber of Commerce – Board Chairman; Northern
          California’s largest regional chamber of commerce
        </p>
      </div>
    </div>
  );
