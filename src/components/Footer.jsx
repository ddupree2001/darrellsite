...
const Footer = ({ open }) => {
  return (
    <div className="bg-[#EFEDE6] w-full">
      <div className="max-w-screen-2xl mx-auto px-4 md:px-12 xl:px-16 2xl:px-20 py-10">
        <div className="flex items-center text-[#333333] w-full">
          <div className="w-1/4">
            <img
              src={logo}
          ...
          <div className="w-1/4 flex flex-col items-center h-[150px]">
